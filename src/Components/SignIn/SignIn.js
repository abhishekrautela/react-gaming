...
const SignIn = () => {
  return (
      <React.Fragment>
      <a aria-current="page" className="nav-link Ripple-parent active" data-test="nav-link" id="nav-links"  data-target="#signin" data-toggle="modal" data-backdrop="false">Login</a>
